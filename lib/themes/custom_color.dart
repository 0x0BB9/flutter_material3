...
const customcolor1 = Color(0xFF006699);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF006699),
  customcolor1: Color(0xFF006496),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFCCE5FF),
  onCustomcolor1Container: Color(0xFF001E31),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF006699),
  customcolor1: Color(0xFF90CDFF),
  onCustomcolor1: Color(0xFF003350),
  customcolor1Container: Color(0xFF004B72),
  onCustomcolor1Container: Color(0xFFCCE5FF),
);
